...
public class MappingPropertyTest {
    ...
    public void without_dependencies() {
        TestIntrospectionImpl introspection = TestIntrospectionImpl.create(Scopes.ROOT)
                .add(new TestPropertyProvider<>(Properties.ONE, Priority.FALLBACK, MappingPropertyTest.class, _ -> Map.of("hello", "world")))
                .build();
    ...
    public void should_always_return_same_instance() {
        ...
        TestIntrospectionImpl introspection = TestIntrospectionImpl.create(Scopes.ROOT)
                .add(new TestPropertyProvider<>(Properties.TWO, Priority.FALLBACK, MappingPropertyTest.class, _ -> {
    ...
    public void should_not_accumulate_fallback() {
        TestIntrospectionImpl introspection = TestIntrospectionImpl.create(Scopes.ROOT)
                .add(new TestPropertyProvider<>(Properties.ONE, Priority.FALLBACK, MappingPropertyTest.class, _ -> Map.of("hello", "fallback")))
                .add(new TestPropertyProvider<>(Properties.ONE, Priority.of(10), MappingPropertyTest.class, _ -> Map.of("hello", "world")))
                .build();
    ...
    public void should_accumulate_fallback() {
        TestIntrospectionImpl introspection = TestIntrospectionImpl.create(Scopes.ROOT)
                .add(new TestPropertyProvider<>(Properties.TWO, Priority.FALLBACK, MappingPropertyTest.class, _ -> Map.of("1", new Properties.TestStub())))
                .add(new TestPropertyProvider<>(Properties.TWO, Priority.of(10), MappingPropertyTest.class, _ -> Map.of("2", new Properties.TestStub())))
                .build();
