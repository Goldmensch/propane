...
public class GenerationTest {
    ...
    public void single_property() {
        GenTestIntrospection build = GenTestIntrospectionImpl.create(GenTestScope.ROOT)
                .add(new GenTestPropertyProvider<>(GenTestProperty.FOO_SINGLE, Priority.FALLBACK, GenerationTest.class, _ -> "hi"))
                .build();
    ...
    public void enumeration_test() {
        GenTestIntrospection build = GenTestIntrospectionImpl.create(GenTestScope.ROOT)
                .add(new GenTestPropertyProvider<>(GenTestProperty.FOO_ENUMERATION, Priority.FALLBACK, GenerationTest.class, _ -> List.of("hi")))
                .build();
    ...
    public void mapping_property() {
        GenTestIntrospectionImpl build = GenTestIntrospectionImpl.create(GenTestScope.ROOT)
                .add(new GenTestPropertyProvider<>(GenTestProperty.FOO_MAPPING, Priority.FALLBACK, GenerationTest.class, _ -> Map.of("hello", "world")))
                .build();
